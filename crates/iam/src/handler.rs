    ...
    pub fn handle(&self, req: AwsRequest) -> AwsResponse {
        ...
        match op {
            ...
            "UpdateDelegationRequest" => self.xml_empty(&req, "UpdateDelegationRequest"),
                        "AcceptDelegationRequest" => self.xml_empty(&req, "AcceptDelegationRequest"),
            "AssociateDelegationRequest" => self.xml_empty(&req, "AssociateDelegationRequest"),
            "CreateServiceSpecificCredential" => self.xml_empty(&req, "CreateServiceSpecificCredential"),
            "DeleteRolePermissionsBoundary" => self.xml_empty(&req, "DeleteRolePermissionsBoundary"),
            "DeleteServiceSpecificCredential" => self.xml_empty(&req, "DeleteServiceSpecificCredential"),
            "DeleteUserPermissionsBoundary" => self.xml_empty(&req, "DeleteUserPermissionsBoundary"),
            "DisableOrganizationsRootCredentialsManagement" => self.xml_empty(&req, "DisableOrganizationsRootCredentialsManagement"),
            "DisableOrganizationsRootSessions" => self.xml_empty(&req, "DisableOrganizationsRootSessions"),
            "DisableOutboundWebIdentityFederation" => self.xml_empty(&req, "DisableOutboundWebIdentityFederation"),
            "EnableOrganizationsRootCredentialsManagement" => self.xml_empty(&req, "EnableOrganizationsRootCredentialsManagement"),
            "EnableOrganizationsRootSessions" => self.xml_empty(&req, "EnableOrganizationsRootSessions"),
            "EnableOutboundWebIdentityFederation" => self.xml_empty(&req, "EnableOutboundWebIdentityFederation"),
            "GenerateOrganizationsAccessReport" => self.xml_empty(&req, "GenerateOrganizationsAccessReport"),
            "GetContextKeysForCustomPolicy" => self.xml_empty(&req, "GetContextKeysForCustomPolicy"),
            "GetContextKeysForPrincipalPolicy" => self.xml_empty(&req, "GetContextKeysForPrincipalPolicy"),
            "GetHumanReadableSummary" => self.xml_empty(&req, "GetHumanReadableSummary"),
            "GetOrganizationsAccessReport" => self.xml_empty(&req, "GetOrganizationsAccessReport"),
            "GetOutboundWebIdentityFederationInfo" => self.xml_empty(&req, "GetOutboundWebIdentityFederationInfo"),
...
"ListServerCertificateTags" => self.xml_stub_list(&req, "Tags", "ListServerCertificateTags"),
            ...
            "DeleteVirtualMFADevice" => self.xml_empty(&req, "DeleteVirtualMFADevice"),
            "ListMFADeviceTags" => self.xml_stub_list(&req, "Tags", "ListMFADeviceTags"),
            "ListOpenIDConnectProviderTags" => self.xml_stub_list(&req, "Tags", "ListOpenIDConnectProviderTags"),
            "ListSAMLProviderTags" => self.xml_stub_list(&req, "Tags", "ListSAMLProviderTags"),
            "RemoveClientIDFromOpenIDConnectProvider" => self.xml_empty(&req, "RemoveClientIDFromOpenIDConnectProvider"),
