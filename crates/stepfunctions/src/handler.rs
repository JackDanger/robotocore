...
impl StepfunctionsHandler {
    ...
    "CreateStateMachineAlias" => { AwsResponse::json(200, json!({"stateMachineAliasArn": "", "creationDate": Value::Null})) },
    "DeleteStateMachineAlias" => { AwsResponse::json(200, json!({})) },
    "DeleteStateMachineVersion" => { AwsResponse::json(200, json!({})) },
    "DescribeStateMachineAlias" => { AwsResponse::json(200, json!({"stateMachineAliasArn": "", "name": "", "description": "", "routingConfiguration": json!([]), "creationDate": Value::Null, "updateDate": Value::Null})) },
    "RedriveExecution" => { AwsResponse::json(200, json!({"redriveDate": Value::Null})) },
    "StartSyncExecution" => { AwsResponse::json(200, json!({"executionArn": "", "stateMachineArn": "", "name": "", "startDate": Value::Null, "stopDate": Value::Null, "status": "", "error": "", "cause": "", "input": "", "inputDetails": json!({"included": false}), "output": "", "outputDetails": json!({"included": false}), "traceHeader": "", "billingDetails": json!({"billedMemoryUsedInMB": 0, "billedDurationInMilliseconds": 0})})) },
    "TestState" => { AwsResponse::json(200, json!({"output": "", "error": "", "cause": "", "inspectionData": json!({"input": "", "afterArguments": "", "afterInputPath": "", "afterParameters": "", "result": "", "afterResultSelector": "", "afterResultPath": "", "request": json!({"protocol": "", "method": "", "url": "", "headers": "", "body": ""}), "response": json!({"protocol": "", "statusCode": "", "statusMessage": "", "headers": "", "body": ""}), "variables": "", "errorDetails": json!({"catchIndex": 0, "retryIndex": 0, "retryBackoffIntervalSeconds": 0}), "afterItemsPath": "", "afterItemSelector": "", "afterItemBatcher": "", "afterItemsPointer": "", "toleratedFailureCount": 0, "toleratedFailurePercentage": "", "maxConcurrency": 0}), "nextState": "", "status": ""})) },
    "UpdateStateMachineAlias" => { AwsResponse::json(200, json!({"updateDate": Value::Null})) },
