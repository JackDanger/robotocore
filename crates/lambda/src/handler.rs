    ...
    pub fn handle(&self, req: AwsRequest) -> AwsResponse {
        ...
        match op {
            ...
            "DeleteFunctionRecursionConfiguration" => self.json_stub(&req, "{}"),
                "CheckpointDurableExecution" => { AwsResponse::json(200, json!({"CheckpointToken": "", "NewExecutionState": json!({"Operations": json!([]), "NextMarker": ""})})) },
    "CreateCodeSigningConfig" => { AwsResponse::json(200, json!({"CodeSigningConfig": json!({"CodeSigningConfigId": "", "CodeSigningConfigArn": "", "Description": "", "AllowedPublishers": json!({"SigningProfileVersionArns": json!([])}), "CodeSigningPolicies": json!({"UntrustedArtifactOnDeployment": ""}), "LastModified": ""})})) },
    "DeleteFunctionCodeSigningConfig" => { AwsResponse::json(200, json!({})) },
    "DeleteFunctionEventInvokeConfig" => { AwsResponse::json(200, json!({})) },
    "GetDurableExecutionState" => { AwsResponse::json(200, json!({"Operations": json!([]), "NextMarker": ""})) },
    "GetFunctionCodeSigningConfig" => { AwsResponse::json(200, json!({"CodeSigningConfigArn": "", "FunctionName": ""})) },
    "GetFunctionEventInvokeConfig" => { AwsResponse::json(200, json!({"LastModified": Value::Null, "FunctionArn": "", "MaximumRetryAttempts": 0, "MaximumEventAgeInSeconds": 0, "DestinationConfig": json!({"OnSuccess": json!({"Destination": ""}), "OnFailure": json!({"Destination": ""})})})) },
    "GetFunctionRecursionConfig" => { AwsResponse::json(200, json!({"RecursiveLoop": ""})) },
    "GetFunctionScalingConfig" => { AwsResponse::json(200, json!({"FunctionArn": "", "AppliedFunctionScalingConfig": json!({"MinExecutionEnvironments": 0, "MaxExecutionEnvironments": 0}), "RequestedFunctionScalingConfig": json!({"MinExecutionEnvironments": 0, "MaxExecutionEnvironments": 0})})) },
    "GetRuntimeManagementConfig" => { AwsResponse::json(200, json!({"UpdateRuntimeOn": "", "RuntimeVersionArn": "", "FunctionArn": ""})) },
    "InvokeWithResponseStream" => { AwsResponse::json(200, json!({"StatusCode": 0, "X-Amz-Executed-Version": "", "EventStream": json!({"PayloadChunk": json!({"Payload": Value::Null}), "InvokeComplete": json!({"ErrorCode": "", "ErrorDetails": "", "LogResult": ""})}), "Content-Type": ""})) },
    "ListCodeSigningConfigs" => { AwsResponse::json(200, json!({"NextMarker": "", "CodeSigningConfigs": json!([])})) },
    "ListDurableExecutionsByFunction" => { AwsResponse::json(200, json!({"DurableExecutions": json!([]), "NextMarker": ""})) },
    "ListFunctionEventInvokeConfigs" => { AwsResponse::json(200, json!({"FunctionEventInvokeConfigs": json!([]), "NextMarker": ""})) },
    "ListFunctionVersionsByCapacityProvider" => { AwsResponse::json(200, json!({"CapacityProviderArn": "", "FunctionVersions": json!([]), "NextMarker": ""})) },
    "ListFunctionsByCodeSigningConfig" => { AwsResponse::json(200, json!({"NextMarker": "", "FunctionArns": json!([])})) },
    "PutFunctionCodeSigningConfig" => { AwsResponse::json(200, json!({"CodeSigningConfigArn": "", "FunctionName": ""})) },
    "PutFunctionEventInvokeConfig" => { AwsResponse::json(200, json!({"LastModified": Value::Null, "FunctionArn": "", "MaximumRetryAttempts": 0, "MaximumEventAgeInSeconds": 0, "DestinationConfig": json!({"OnSuccess": json!({"Destination": ""}), "OnFailure": json!({"Destination": ""})})})) },
    "PutFunctionRecursionConfig" => { AwsResponse::json(200, json!({"RecursiveLoop": ""})) },
    "PutFunctionScalingConfig" => { AwsResponse::json(200, json!({"FunctionState": ""})) },
    "PutRuntimeManagementConfig" => { AwsResponse::json(200, json!({"UpdateRuntimeOn": "", "FunctionArn": "", "RuntimeVersionArn": ""})) },
    "SendDurableExecutionCallbackFailure" => { AwsResponse::json(200, json!({})) },
    "SendDurableExecutionCallbackHeartbeat" => { AwsResponse::json(200, json!({})) },
    "SendDurableExecutionCallbackSuccess" => { AwsResponse::json(200, json!({})) },
    "StopDurableExecution" => { AwsResponse::json(200, json!({"StopTimestamp": Value::Null})) },
    "UpdateCodeSigningConfig" => { AwsResponse::json(200, json!({"CodeSigningConfig": json!({"CodeSigningConfigId": "", "CodeSigningConfigArn": "", "Description": "", "AllowedPublishers": json!({"SigningProfileVersionArns": json!([])}), "CodeSigningPolicies": json!({"UntrustedArtifactOnDeployment": ""}), "LastModified": ""})})) },
    "UpdateFunctionEventInvokeConfig" => { AwsResponse::json(200, json!({"LastModified": Value::Null, "FunctionArn": "", "MaximumRetryAttempts": 0, "MaximumEventAgeInSeconds": 0, "DestinationConfig": json!({"OnSuccess": json!({"Destination": ""}), "OnFailure": json!({"Destination": ""})})})) },
