...
impl KmsHandler {
    ...
    "ConnectCustomKeyStore" => { AwsResponse::json(200, json!({})) },
    "DeleteCustomKeyStore" => { AwsResponse::json(200, json!({})) },
    "DeleteImportedKeyMaterial" => { AwsResponse::json(200, json!({"KeyId": "", "KeyMaterialId": ""})) },
    "DisconnectCustomKeyStore" => { AwsResponse::json(200, json!({})) },
    "ImportKeyMaterial" => { AwsResponse::json(200, json!({"KeyId": "", "KeyMaterialId": ""})) },
    "UpdateCustomKeyStore" => { AwsResponse::json(200, json!({})) },
    "Verify" => { AwsResponse::json(200, json!({"KeyId": "", "SignatureValid": false, "SigningAlgorithm": ""})) },
    "VerifyMac" => { AwsResponse::json(200, json!({"KeyId": "", "MacValid": false, "MacAlgorithm": ""})) },
