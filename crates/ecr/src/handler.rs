...
impl EcrHandler {
    ...
    "DeletePullThroughCacheRule" => { AwsResponse::json(200, json!({"ecrRepositoryPrefix": "", "upstreamRegistryUrl": "", "createdAt": Value::Null, "registryId": "", "credentialArn": "", "customRoleArn": "", "upstreamRepositoryPrefix": ""})) },
    "DeleteRegistryPolicy" => { AwsResponse::json(200, json!({"registryId": "", "policyText": ""})) },
    "DeleteRepositoryCreationTemplate" => { AwsResponse::json(200, json!({"registryId": "", "repositoryCreationTemplate": json!({"prefix": "", "description": "", "encryptionConfiguration": json!({"encryptionType": "", "kmsKey": ""}), "resourceTags": json!([]), "imageTagMutability": "", "imageTagMutabilityExclusionFilters": json!([]), "repositoryPolicy": "", "lifecyclePolicy": "", "appliedFor": json!([]), "customRoleArn": "", "createdAt": Value::Null, "updatedAt": Value::Null})})) },
    "DeleteSigningConfiguration" => { AwsResponse::json(200, json!({"registryId": "", "signingConfiguration": json!({"rules": json!([])})})) },
    "DeregisterPullTimeUpdateExclusion" => { AwsResponse::json(200, json!({"principalArn": ""})) },
    "DescribeImageReplicationStatus" => { AwsResponse::json(200, json!({"repositoryName": "", "imageId": json!({"imageDigest": "", "imageTag": ""}), "replicationStatuses": json!([])})) },
    "DescribeRepositoryCreationTemplates" => { AwsResponse::json(200, json!({"registryId": "", "repositoryCreationTemplates": json!([]), "nextToken": ""})) },
    "GetAccountSetting" => { AwsResponse::json(200, json!({"name": "", "value": ""})) },
    "GetLifecyclePolicyPreview" => { AwsResponse::json(200, json!({"registryId": "", "repositoryName": "", "lifecyclePolicyText": "", "status": "", "nextToken": "", "previewResults": json!([]), "summary": json!({"expiringImageTotalCount": 0, "transitioningImageTotalCounts": json!([])})})) },
    "GetRegistryPolicy" => { AwsResponse::json(200, json!({"registryId": "", "policyText": ""})) },
    "RegisterPullTimeUpdateExclusion" => { AwsResponse::json(200, json!({"principalArn": "", "createdAt": Value::Null})) },
    "StartLifecyclePolicyPreview" => { AwsResponse::json(200, json!({"registryId": "", "repositoryName": "", "lifecyclePolicyText": "", "status": ""})) },
    "UpdatePullThroughCacheRule" => { AwsResponse::json(200, json!({"ecrRepositoryPrefix": "", "registryId": "", "updatedAt": Value::Null, "credentialArn": "", "customRoleArn": "", "upstreamRepositoryPrefix": ""})) },
    "UpdateRepositoryCreationTemplate" => { AwsResponse::json(200, json!({"registryId": "", "repositoryCreationTemplate": json!({"prefix": "", "description": "", "encryptionConfiguration": json!({"encryptionType": "", "kmsKey": ""}), "resourceTags": json!([]), "imageTagMutability": "", "imageTagMutabilityExclusionFilters": json!([]), "repositoryPolicy": "", "lifecyclePolicy": "", "appliedFor": json!([]), "customRoleArn": "", "createdAt": Value::Null, "updatedAt": Value::Null})})) },
    "ValidatePullThroughCacheRule" => { AwsResponse::json(200, json!({"ecrRepositoryPrefix": "", "registryId": "", "upstreamRegistryUrl": "", "credentialArn": "", "customRoleArn": "", "upstreamRepositoryPrefix": "", "isValid": false, "failure": ""})) },
