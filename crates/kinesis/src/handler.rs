...
impl KinesisHandler {
    ...
    pub fn handle(&self, req: AwsRequest) -> AwsResponse {
        ...
        match op {
            ...
            "StopStreamEncryption" => self.json_stub(&req, "StopStreamEncryption"),
            "DescribeStreamEncryption" => self.json_stub(&req, "DescribeStreamEncryption"),
            ...
            Some(stream) => {
                let shards: Vec<Value> = stream.shards.read().iter().map(|s| {
                    json!({
                        ...
                        "HashKeyRange": {
                            "StartingHashKey": "0",
                            "EndingHashKey": ""
                        },
