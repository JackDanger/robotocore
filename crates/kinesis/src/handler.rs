...
impl KinesisHandler {
    ...
    "DecreaseStreamRetentionPeriod" => { AwsResponse::json(200, json!({})) },
    "DeleteResourcePolicy" => { AwsResponse::json(200, json!({})) },
    "DeregisterStreamConsumer" => { AwsResponse::json(200, json!({})) },
    "DescribeStreamConsumer" => { AwsResponse::json(200, json!({"ConsumerDescription": json!({"ConsumerName": "", "ConsumerARN": "", "ConsumerStatus": "", "ConsumerCreationTimestamp": Value::Null, "StreamARN": ""})})) },
    "DisableEnhancedMonitoring" => { AwsResponse::json(200, json!({"StreamName": "", "CurrentShardLevelMetrics": json!([]), "DesiredShardLevelMetrics": json!([]), "StreamARN": ""})) },
    "GetResourcePolicy" => { AwsResponse::json(200, json!({"Policy": ""})) },
    "ListTagsForResource" => { AwsResponse::json(200, json!({"Tags": json!([])})) },
    "StopStreamEncryption" => { AwsResponse::json(200, json!({})) },
    "SubscribeToShard" => { AwsResponse::json(200, json!({"EventStream": json!({"SubscribeToShardEvent": json!({"Records": json!([]), "ContinuationSequenceNumber": "", "MillisBehindLatest": 0, "ChildShards": json!([])}), "ResourceNotFoundException": json!({"message": ""}), "ResourceInUseException": json!({"message": ""}), "KMSDisabledException": json!({"message": ""}), "KMSInvalidStateException": json!({"message": ""}), "KMSAccessDeniedException": json!({"message": ""}), "KMSNotFoundException": json!({"message": ""}), "KMSOptInRequired": json!({"message": ""}), "KMSThrottlingException": json!({"message": ""}), "InternalFailureException": json!({"message": ""})})})) },
    "UntagResource" => { AwsResponse::json(200, json!({})) },
    "UpdateMaxRecordSize" => { AwsResponse::json(200, json!({})) },
    "UpdateStreamWarmThroughput" => { AwsResponse::json(200, json!({"StreamARN": "", "StreamName": "", "WarmThroughput": json!({"TargetMiBps": 0, "CurrentMiBps": 0})})) },
