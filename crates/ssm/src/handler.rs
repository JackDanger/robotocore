    ...
    pub fn handle(&self, req: AwsRequest) -> AwsResponse {
        ...
        match op {
            ...
            "UpdateDocumentDefaultVersion" => self.json_stub(&req, "DocumentVersion"),
                "CancelCommand" => { AwsResponse::json(200, json!({})) },
    "CancelMaintenanceWindowExecution" => { AwsResponse::json(200, json!({"WindowExecutionId": ""})) },
    "DeleteActivation" => { AwsResponse::json(200, json!({})) },
    "DeleteAssociation" => { AwsResponse::json(200, json!({})) },
    "DeleteOpsMetadata" => { AwsResponse::json(200, json!({})) },
    "DeletePatchBaseline" => { AwsResponse::json(200, json!({"BaselineId": ""})) },
    "DeleteResourcePolicy" => { AwsResponse::json(200, json!({})) },
    "DeregisterPatchBaselineForPatchGroup" => { AwsResponse::json(200, json!({"BaselineId": "", "PatchGroup": ""})) },
    "DeregisterTargetFromMaintenanceWindow" => { AwsResponse::json(200, json!({"WindowId": "", "WindowTargetId": ""})) },
    "DeregisterTaskFromMaintenanceWindow" => { AwsResponse::json(200, json!({"WindowId": "", "WindowTaskId": ""})) },
    "DescribeAssociation" => { AwsResponse::json(200, json!({"AssociationDescription": json!({"Name": "", "InstanceId": "", "AssociationVersion": "", "Date": Value::Null, "LastUpdateAssociationDate": Value::Null, "Status": json!({"Date": Value::Null, "Name": "", "Message": "", "AdditionalInfo": ""}), "Overview": json!({"Status": "", "DetailedStatus": "", "AssociationStatusAggregatedCount": json!({})}), "DocumentVersion": "", "AutomationTargetParameterName": "", "Parameters": json!({}), "AssociationId": "", "Targets": json!([]), "ScheduleExpression": "", "OutputLocation": json!({"S3Location": json!({"OutputS3Region": "", "OutputS3BucketName": "", "OutputS3KeyPrefix": ""})}), "LastExecutionDate": Value::Null, "LastSuccessfulExecutionDate": Value::Null, "AssociationName": "", "MaxErrors": "", "MaxConcurrency": "", "ComplianceSeverity": "", "SyncCompliance": "", "ApplyOnlyAtCronInterval": false, "CalendarNames": json!([]), "TargetLocations": json!([]), "ScheduleOffset": 0, "Duration": 0, "TargetMaps": json!([]), "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])}), "TriggeredAlarms": json!([]), "AssociationDispatchAssumeRole": ""})})) },
    "DescribeAssociationExecutionTargets" => { AwsResponse::json(200, json!({"AssociationExecutionTargets": json!([]), "NextToken": ""})) },
    "DescribeAssociationExecutions" => { AwsResponse::json(200, json!({"AssociationExecutions": json!([]), "NextToken": ""})) },
    "DescribeAutomationStepExecutions" => { AwsResponse::json(200, json!({"StepExecutions": json!([]), "NextToken": ""})) },
    "DescribeMaintenanceWindowExecutionTaskInvocations" => { AwsResponse::json(200, json!({"WindowExecutionTaskInvocationIdentities": json!([]), "NextToken": ""})) },
    "DescribeMaintenanceWindowExecutionTasks" => { AwsResponse::json(200, json!({"WindowExecutionTaskIdentities": json!([]), "NextToken": ""})) },
    "DescribeMaintenanceWindowTargets" => { AwsResponse::json(200, json!({"Targets": json!([]), "NextToken": ""})) },
    "DescribeMaintenanceWindowTasks" => { AwsResponse::json(200, json!({"Tasks": json!([]), "NextToken": ""})) },
    "DisassociateOpsItemRelatedItem" => { AwsResponse::json(200, json!({})) },
    "GetAutomationExecution" => { AwsResponse::json(200, json!({"AutomationExecution": json!({"AutomationExecutionId": "", "DocumentName": "", "DocumentVersion": "", "ExecutionStartTime": Value::Null, "ExecutionEndTime": Value::Null, "AutomationExecutionStatus": "", "StepExecutions": json!([]), "StepExecutionsTruncated": false, "Parameters": json!({}), "Outputs": json!({}), "FailureMessage": "", "Mode": "", "ParentAutomationExecutionId": "", "ExecutedBy": "", "CurrentStepName": "", "CurrentAction": "", "TargetParameterName": "", "Targets": json!([]), "TargetMaps": json!([]), "ResolvedTargets": json!({"ParameterValues": json!([]), "Truncated": false}), "MaxConcurrency": "", "MaxErrors": "", "Target": "", "TargetLocations": json!([]), "ProgressCounters": json!({"TotalSteps": 0, "SuccessSteps": 0, "FailedSteps": 0, "CancelledSteps": 0, "TimedOutSteps": 0}), "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])}), "TriggeredAlarms": json!([]), "TargetLocationsURL": "", "AutomationSubtype": "", "ScheduledTime": Value::Null, "Runbooks": json!([]), "OpsItemId": "", "AssociationId": "", "ChangeRequestName": "", "Variables": json!({})})})) },
    "GetCalendarState" => { AwsResponse::json(200, json!({"State": "", "AtTime": "", "NextTransitionTime": ""})) },
    "GetCommandInvocation" => { AwsResponse::json(200, json!({"CommandId": "", "InstanceId": "", "Comment": "", "DocumentName": "", "DocumentVersion": "", "PluginName": "", "ResponseCode": 0, "ExecutionStartDateTime": "", "ExecutionElapsedTime": "", "ExecutionEndDateTime": "", "Status": "", "StatusDetails": "", "StandardOutputContent": "", "StandardOutputUrl": "", "StandardErrorContent": "", "StandardErrorUrl": "", "CloudWatchOutputConfig": json!({"CloudWatchLogGroupName": "", "CloudWatchOutputEnabled": false})})) },
    "GetExecutionPreview" => { AwsResponse::json(200, json!({"ExecutionPreviewId": "", "EndedAt": Value::Null, "Status": "", "StatusMessage": "", "ExecutionPreview": json!({"Automation": json!({"StepPreviews": json!({}), "Regions": json!([]), "TargetPreviews": json!([]), "TotalAccounts": 0})})})) },
    "GetMaintenanceWindowExecution" => { AwsResponse::json(200, json!({"WindowExecutionId": "", "TaskIds": json!([]), "Status": "", "StatusDetails": "", "StartTime": Value::Null, "EndTime": Value::Null})) },
    "GetMaintenanceWindowExecutionTask" => { AwsResponse::json(200, json!({"WindowExecutionId": "", "TaskExecutionId": "", "TaskArn": "", "ServiceRole": "", "Type": "", "TaskParameters": json!([]), "Priority": 0, "MaxConcurrency": "", "MaxErrors": "", "Status": "", "StatusDetails": "", "StartTime": Value::Null, "EndTime": Value::Null, "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])}), "TriggeredAlarms": json!([])})) },
    "GetMaintenanceWindowExecutionTaskInvocation" => { AwsResponse::json(200, json!({"WindowExecutionId": "", "TaskExecutionId": "", "InvocationId": "", "ExecutionId": "", "TaskType": "", "Parameters": "", "Status": "", "StatusDetails": "", "StartTime": Value::Null, "EndTime": Value::Null, "OwnerInformation": "", "WindowTargetId": ""})) },
    "GetMaintenanceWindowTask" => { AwsResponse::json(200, json!({"WindowId": "", "WindowTaskId": "", "Targets": json!([]), "TaskArn": "", "ServiceRoleArn": "", "TaskType": "", "TaskParameters": json!({}), "TaskInvocationParameters": json!({"RunCommand": json!({"Comment": "", "CloudWatchOutputConfig": json!({"CloudWatchLogGroupName": "", "CloudWatchOutputEnabled": false}), "DocumentHash": "", "DocumentHashType": "", "DocumentVersion": "", "NotificationConfig": json!({"NotificationArn": "", "NotificationEvents": json!([]), "NotificationType": ""}), "OutputS3BucketName": "", "OutputS3KeyPrefix": "", "Parameters": json!({}), "ServiceRoleArn": "", "TimeoutSeconds": 0}), "Automation": json!({"DocumentVersion": "", "Parameters": json!({})}), "StepFunctions": json!({"Input": "", "Name": ""}), "Lambda": json!({"ClientContext": "", "Qualifier": "", "Payload": Value::Null})}), "Priority": 0, "MaxConcurrency": "", "MaxErrors": "", "LoggingInfo": json!({"S3BucketName": "", "S3KeyPrefix": "", "S3Region": ""}), "Name": "", "Description": "", "CutoffBehavior": "", "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])})})) },
    "GetOpsMetadata" => { AwsResponse::json(200, json!({"ResourceId": "", "Metadata": json!({}), "NextToken": ""})) },
    "GetPatchBaselineForPatchGroup" => { AwsResponse::json(200, json!({"BaselineId": "", "PatchGroup": "", "OperatingSystem": ""})) },
    "ListAssociationVersions" => { AwsResponse::json(200, json!({"AssociationVersions": json!([]), "NextToken": ""})) },
    "ListOpsItemRelatedItems" => { AwsResponse::json(200, json!({"NextToken": "", "Summaries": json!([])})) },
    "RegisterPatchBaselineForPatchGroup" => { AwsResponse::json(200, json!({"BaselineId": "", "PatchGroup": ""})) },
    "RegisterTargetWithMaintenanceWindow" => { AwsResponse::json(200, json!({"WindowTargetId": ""})) },
    "RegisterTaskWithMaintenanceWindow" => { AwsResponse::json(200, json!({"WindowTaskId": ""})) },
    "SendAutomationSignal" => { AwsResponse::json(200, json!({})) },
    "StopAutomationExecution" => { AwsResponse::json(200, json!({})) },
    "UpdateAssociation" => { AwsResponse::json(200, json!({"AssociationDescription": json!({"Name": "", "InstanceId": "", "AssociationVersion": "", "Date": Value::Null, "LastUpdateAssociationDate": Value::Null, "Status": json!({"Date": Value::Null, "Name": "", "Message": "", "AdditionalInfo": ""}), "Overview": json!({"Status": "", "DetailedStatus": "", "AssociationStatusAggregatedCount": json!({})}), "DocumentVersion": "", "AutomationTargetParameterName": "", "Parameters": json!({}), "AssociationId": "", "Targets": json!([]), "ScheduleExpression": "", "OutputLocation": json!({"S3Location": json!({"OutputS3Region": "", "OutputS3BucketName": "", "OutputS3KeyPrefix": ""})}), "LastExecutionDate": Value::Null, "LastSuccessfulExecutionDate": Value::Null, "AssociationName": "", "MaxErrors": "", "MaxConcurrency": "", "ComplianceSeverity": "", "SyncCompliance": "", "ApplyOnlyAtCronInterval": false, "CalendarNames": json!([]), "TargetLocations": json!([]), "ScheduleOffset": 0, "Duration": 0, "TargetMaps": json!([]), "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])}), "TriggeredAlarms": json!([]), "AssociationDispatchAssumeRole": ""})})) },
    "UpdateAssociationStatus" => { AwsResponse::json(200, json!({"AssociationDescription": json!({"Name": "", "InstanceId": "", "AssociationVersion": "", "Date": Value::Null, "LastUpdateAssociationDate": Value::Null, "Status": json!({"Date": Value::Null, "Name": "", "Message": "", "AdditionalInfo": ""}), "Overview": json!({"Status": "", "DetailedStatus": "", "AssociationStatusAggregatedCount": json!({})}), "DocumentVersion": "", "AutomationTargetParameterName": "", "Parameters": json!({}), "AssociationId": "", "Targets": json!([]), "ScheduleExpression": "", "OutputLocation": json!({"S3Location": json!({"OutputS3Region": "", "OutputS3BucketName": "", "OutputS3KeyPrefix": ""})}), "LastExecutionDate": Value::Null, "LastSuccessfulExecutionDate": Value::Null, "AssociationName": "", "MaxErrors": "", "MaxConcurrency": "", "ComplianceSeverity": "", "SyncCompliance": "", "ApplyOnlyAtCronInterval": false, "CalendarNames": json!([]), "TargetLocations": json!([]), "ScheduleOffset": 0, "Duration": 0, "TargetMaps": json!([]), "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])}), "TriggeredAlarms": json!([]), "AssociationDispatchAssumeRole": ""})})) },
    "UpdateMaintenanceWindow" => { AwsResponse::json(200, json!({"WindowId": "", "Name": "", "Description": "", "StartDate": "", "EndDate": "", "Schedule": "", "ScheduleTimezone": "", "ScheduleOffset": 0, "Duration": 0, "Cutoff": 0, "AllowUnassociatedTargets": false, "Enabled": false})) },
    "UpdateMaintenanceWindowTarget" => { AwsResponse::json(200, json!({"WindowId": "", "WindowTargetId": "", "Targets": json!([]), "OwnerInformation": "", "Name": "", "Description": ""})) },
    "UpdateMaintenanceWindowTask" => { AwsResponse::json(200, json!({"WindowId": "", "WindowTaskId": "", "Targets": json!([]), "TaskArn": "", "ServiceRoleArn": "", "TaskParameters": json!({}), "TaskInvocationParameters": json!({"RunCommand": json!({"Comment": "", "CloudWatchOutputConfig": json!({"CloudWatchLogGroupName": "", "CloudWatchOutputEnabled": false}), "DocumentHash": "", "DocumentHashType": "", "DocumentVersion": "", "NotificationConfig": json!({"NotificationArn": "", "NotificationEvents": json!([]), "NotificationType": ""}), "OutputS3BucketName": "", "OutputS3KeyPrefix": "", "Parameters": json!({}), "ServiceRoleArn": "", "TimeoutSeconds": 0}), "Automation": json!({"DocumentVersion": "", "Parameters": json!({})}), "StepFunctions": json!({"Input": "", "Name": ""}), "Lambda": json!({"ClientContext": "", "Qualifier": "", "Payload": Value::Null})}), "Priority": 0, "MaxConcurrency": "", "MaxErrors": "", "LoggingInfo": json!({"S3BucketName": "", "S3KeyPrefix": "", "S3Region": ""}), "Name": "", "Description": "", "CutoffBehavior": "", "AlarmConfiguration": json!({"IgnorePollAlarmFailure": false, "Alarms": json!([])})})) },
    "UpdateOpsMetadata" => { AwsResponse::json(200, json!({"OpsMetadataArn": ""})) },
    "UpdatePatchBaseline" => { AwsResponse::json(200, json!({"BaselineId": "", "Name": "", "OperatingSystem": "", "GlobalFilters": json!({"PatchFilters": json!([])}), "ApprovalRules": json!({"PatchRules": json!([])}), "ApprovedPatches": json!([]), "ApprovedPatchesComplianceLevel": "", "ApprovedPatchesEnableNonSecurity": false, "RejectedPatches": json!([]), "RejectedPatchesAction": "", "CreatedDate": Value::Null, "ModifiedDate": Value::Null, "Description": "", "Sources": json!([]), "AvailableSecurityUpdatesComplianceStatus": ""})) },
    "UpdateResourceDataSync" => { AwsResponse::json(200, json!({})) },
