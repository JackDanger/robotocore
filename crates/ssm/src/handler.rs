...
impl SsmHandler {
    ...
    pub fn handle(&self, req: AwsRequest) -> AwsResponse {
        ...
        match op {
            ...
            "DescribeAutomationExecutions" => self.json_stub_list(&req, "AutomationExecutionInfos"),
            "ListComplianceItems" => self.json_stub_list(&req, "ComplianceItems"),
            "ListComplianceSummaries" => self.json_stub_list(&req, "ComplianceSummaryCountByStatus"),
            "ListResourceComplianceSummaries" => self.json_stub_list(&req, "ResourceComplianceSummaryList"),
            "DescribeOpsItems" => self.json_stub_list(&req, "OpsItems"),
