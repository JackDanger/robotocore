    ...
    pub fn handle(&self, req: AwsRequest) -> AwsResponse {
        ...
        match operation {
            ...
            "UpdateTableReplicaAutoScaling" => self.json_stub(&req, "TableReplicaAutoScalingDescription"),
                "DescribeContributorInsights" => { AwsResponse::json(200, json!({"TableName": "", "IndexName": "", "ContributorInsightsRuleList": json!([]), "ContributorInsightsStatus": "", "LastUpdateDateTime": Value::Null, "FailureException": json!({"ExceptionName": "", "ExceptionDescription": ""}), "ContributorInsightsMode": ""})) },
    "DescribeExport" => { AwsResponse::json(200, json!({"ExportDescription": json!({"ExportArn": "", "ExportStatus": "", "StartTime": Value::Null, "EndTime": Value::Null, "ExportManifest": "", "TableArn": "", "TableId": "", "ExportTime": Value::Null, "ClientToken": "", "S3Bucket": "", "S3BucketOwner": "", "S3Prefix": "", "S3SseAlgorithm": "", "S3SseKmsKeyId": "", "FailureCode": "", "FailureMessage": "", "ExportFormat": "", "BilledSizeBytes": 0, "ItemCount": 0, "ExportType": "", "IncrementalExportSpecification": json!({"ExportFromTime": Value::Null, "ExportToTime": Value::Null, "ExportViewType": ""})})})) },
    "DescribeGlobalTable" => { AwsResponse::json(200, json!({"GlobalTableDescription": json!({"ReplicationGroup": json!([]), "GlobalTableArn": "", "CreationDateTime": Value::Null, "GlobalTableStatus": "", "GlobalTableName": ""})})) },
    "DescribeGlobalTableSettings" => { AwsResponse::json(200, json!({"GlobalTableName": "", "ReplicaSettings": json!([])})) },
    "DescribeImport" => { AwsResponse::json(200, json!({"ImportTableDescription": json!({"ImportArn": "", "ImportStatus": "", "TableArn": "", "TableId": "", "ClientToken": "", "S3BucketSource": json!({"S3BucketOwner": "", "S3Bucket": "", "S3KeyPrefix": ""}), "ErrorCount": 0, "CloudWatchLogGroupArn": "", "InputFormat": "", "InputFormatOptions": json!({"Csv": json!({"Delimiter": "", "HeaderList": json!([])})}), "InputCompressionType": "", "TableCreationParameters": json!({"TableName": "", "AttributeDefinitions": json!([]), "KeySchema": json!([]), "BillingMode": "", "ProvisionedThroughput": json!({"ReadCapacityUnits": 0, "WriteCapacityUnits": 0}), "OnDemandThroughput": json!({"MaxReadRequestUnits": 0, "MaxWriteRequestUnits": 0}), "SSESpecification": json!({"Enabled": false, "SSEType": "", "KMSMasterKeyId": ""}), "GlobalSecondaryIndexes": json!([])}), "StartTime": Value::Null, "EndTime": Value::Null, "ProcessedSizeBytes": 0, "ProcessedItemCount": 0, "ImportedItemCount": 0, "FailureCode": "", "FailureMessage": ""})})) },
    "DescribeKinesisStreamingDestination" => { AwsResponse::json(200, json!({"TableName": "", "KinesisDataStreamDestinations": json!([])})) },
    "DisableKinesisStreamingDestination" => { AwsResponse::json(200, json!({"TableName": "", "StreamArn": "", "DestinationStatus": "", "EnableKinesisStreamingConfiguration": json!({"ApproximateCreationDateTimePrecision": ""})})) },
    "UpdateGlobalTable" => { AwsResponse::json(200, json!({"GlobalTableDescription": json!({"ReplicationGroup": json!([]), "GlobalTableArn": "", "CreationDateTime": Value::Null, "GlobalTableStatus": "", "GlobalTableName": ""})})) },
    "UpdateKinesisStreamingDestination" => { AwsResponse::json(200, json!({"TableName": "", "StreamArn": "", "DestinationStatus": "", "UpdateKinesisStreamingConfiguration": json!({"ApproximateCreationDateTimePrecision": ""})})) },
