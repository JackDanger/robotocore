...
impl CloudwatchHandler {
    ...
    "DeleteDashboards" => { AwsResponse::json(200, json!({})) },
    "DeleteInsightRules" => { AwsResponse::json(200, json!({})) },
    "DescribeInsightRules" => { AwsResponse::json(200, json!({})) },
    "DisableInsightRules" => { AwsResponse::json(200, json!({})) },
    "EnableAlarmActions" => { AwsResponse::xml(200, String::new()) },
    "EnableInsightRules" => { AwsResponse::json(200, json!({})) },
    "GetAlarmMuteRule" => { AwsResponse::json(200, json!({})) },
    "GetInsightRuleReport" => { AwsResponse::json(200, json!({})) },
    "GetMetricStream" => { AwsResponse::json(200, json!({})) },
    "StartMetricStreams" => { AwsResponse::json(200, json!({})) },
    "StopMetricStreams" => { AwsResponse::json(200, json!({})) },
